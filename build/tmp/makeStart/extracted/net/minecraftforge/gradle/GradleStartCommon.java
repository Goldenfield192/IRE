...
public abstract class GradleStartCommon
{
    ...
    static final File       SRG_DIR       = new File("D:/cache/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/39/srgs");
    static final File       SRG_NOTCH_SRG = new File("D:/cache/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/39/1.12.2/srgs/notch-srg.srg");
    static final File       SRG_NOTCH_MCP = new File("D:/cache/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/39/1.12.2/srgs/notch-mcp.srg");
    static final File       SRG_SRG_MCP   = new File("D:/cache/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/39/1.12.2/srgs/srg-mcp.srg");
    static final File       SRG_MCP_SRG   = new File("D:/cache/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/39/1.12.2/srgs/mcp-srg.srg");
    static final File       SRG_MCP_NOTCH = new File("D:/cache/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/39/1.12.2/srgs/mcp-notch.srg");
    static final File       CSV_DIR       = new File("D:/cache/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/39");
